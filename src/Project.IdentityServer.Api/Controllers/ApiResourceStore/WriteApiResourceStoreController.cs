...
namespace Project.identityserver.Api.Controllers
{
    ...
    public class WriteApiResourceStoreController : ApiControllerWrite<ApiResourceViewModel>
    {
        private readonly IWriteApiResourceStoreAppService _appService;

        public WriteApiResourceStoreController(
            IWriteApiResourceStoreAppService appService,
