...
namespace Project.identityserver.Api.Controllers
{
    ...
    public class WriteClientStoreController : ApiControllerWrite<ClientViewModel>
    {
        private readonly IWriteClientStoreAppService _appService;

        public WriteClientStoreController(
            IWriteClientStoreAppService appService,
