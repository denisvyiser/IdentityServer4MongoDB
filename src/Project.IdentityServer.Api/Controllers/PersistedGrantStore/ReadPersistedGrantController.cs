...
namespace Project.identityserver.Api.Controllers
{
    ...
    public class ReadPersistedGrantController : ApiControllerRead<PersistedGrantViewModel>
    {
        private readonly IReadPersistedGrantStoreAppService _appService;

        public ReadPersistedGrantController(
            IReadPersistedGrantStoreAppService appService,
