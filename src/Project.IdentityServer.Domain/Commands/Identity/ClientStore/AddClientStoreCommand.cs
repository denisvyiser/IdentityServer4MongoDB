...
namespace Project.identityserver.Domain.Commands
{
    public class AddClientStoreCommand : ClientStoreCommand, IAddCommand
    {
        ...
        {
            ValidationResult = new AddClientStoreValidation().Validate(this);
