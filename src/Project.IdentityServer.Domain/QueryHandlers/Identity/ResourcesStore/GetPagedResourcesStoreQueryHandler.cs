...
{
    public class GetPagedResourcesStoreQueryHandler : QueryHandlerGetPaged<GetPagedResourcesStoreQuery, ResourcesStore>
    {
        public GetPagedResourcesStoreQueryHandler(
