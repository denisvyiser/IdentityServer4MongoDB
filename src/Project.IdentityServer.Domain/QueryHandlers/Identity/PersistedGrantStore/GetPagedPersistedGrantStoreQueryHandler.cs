...
{
    public class GetPagedPersistedGrantStoreQueryHandler : QueryHandlerGetPaged<GetPagedPersistedGrantStoreQuery, PersistedGrantStore>
    {
        public GetPagedPersistedGrantStoreQueryHandler(
            IReadPersistedGrantStoreMongoDbRepository repository,
