...
{
    public class GetByPersistedGrantStoreQueryHandler : QueryHandlerGetByAsync<GetByPersistedGrantStoreQuery, PersistedGrantStore>
    {
        public GetByPersistedGrantStoreQueryHandler(IMediatorHandler mediator, IReadPersistedGrantStoreMongoDbRepository repository) : base(mediator, repository)
        {
        }
    }
}
