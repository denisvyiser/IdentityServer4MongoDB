...
{
    public class GetByIdentityResourceStoreQueryHandler : QueryHandlerGetByAsync<GetByIdentityResourceStoreQuery, IdentityResourceStore>
    {
        public GetByIdentityResourceStoreQueryHandler(IMediatorHandler mediator, IReadIdentityResourceStoreMongoDbRepository repository) : base(mediator, repository)
        {
        }
    }
}
