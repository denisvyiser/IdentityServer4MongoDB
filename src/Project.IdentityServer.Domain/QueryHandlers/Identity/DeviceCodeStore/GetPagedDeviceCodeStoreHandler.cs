...
{
    public class GetPagedDeviceCodeStoreQueryHandler : QueryHandlerGetPaged<GetPagedDeviceCodeStoreQuery, DeviceCodeStore>
    {
        public GetPagedDeviceCodeStoreQueryHandler(
            IReadDeviceCodeStoreMongoDbRepository repository,
