...
{
    public class ReadDemoAppService : ReadGenericAppService<DemoViewModel, DemoModel, GetDemoQuery, GetPagedDemoQuery>, IReadDemoAppService
    {
        private readonly IMapper _mapper;
        private readonly IMediatorHandler _mediator;
        private readonly DomainNotificationHandler _notifications;

        public ReadDemoAppService(IMapper mapper, IMediatorHandler mediator) : base(mapper,mediator)
        {
            _mapper = mapper;
            _mediator = mediator;
        ...
        public async Task<PagedListMongo<DemoViewModel>> GetPagedFiltered(int page, int size, string orderProperty, bool orderCrescent, string sigla, string codigo)
        {

            
            var builder = Builders<DemoModel>.Filter;

            FilterDefinition<DemoModel> filter = null;
            ...
            return _mapper.Map<PagedListMongo<DemoViewModel>>(paged);
        }
