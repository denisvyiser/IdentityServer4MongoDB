...
{
    public class ReadApiResourceStoreAppService : ReadGenericAppService<ApiResourceViewModel, ApiResourceStore, GetApiResourceStoreQuery, GetPagedApiResourceStoreQuery>, IReadApiResourceStoreAppService
    {
        private readonly IMapper _mapper;
        private readonly IMediatorHandler _mediator;
        private readonly DomainNotificationHandler _notifications;

        public ReadApiResourceStoreAppService(IMapper mapper, IMediatorHandler mediator) : base(mapper,mediator)
        {
            _mapper = mapper;
            _mediator = mediator;
        ...
        public async Task<PagedListMongo<ApiResourceViewModel>> GetPagedFiltered(int page, int size, string orderProperty, bool orderCrescent, string sigla, string codigo)
        {

            
            var builder = Builders<ApiResourceStore>.Filter;

            FilterDefinition<ApiResourceStore> filter = null;
            ...
            var query = new GetPagedApiResourceStoreQuery()
            {
            ...
            return _mapper.Map<PagedListMongo<ApiResourceViewModel>>(paged);
        }
