...
{
    public class ReadPersistedGrantStoreAppService : ReadGenericAppService<PersistedGrantViewModel, PersistedGrantStore, GetPersistedGrantStoreQuery, GetPagedPersistedGrantStoreQuery>, IReadPersistedGrantStoreAppService
    {
        private readonly IMapper _mapper;
        private readonly IMediatorHandler _mediator;
        private readonly DomainNotificationHandler _notifications;

        public ReadPersistedGrantStoreAppService(IMapper mapper, IMediatorHandler mediator) : base(mapper,mediator)
        {
            _mapper = mapper;
            _mediator = mediator;
        ...
        public async Task<PagedListMongo<PersistedGrantViewModel>> GetPagedFiltered(int page, int size, string orderProperty, bool orderCrescent, string sigla, string codigo)
        {
            ...
            var query = new GetPagedPersistedGrantStoreQuery()
            {
            ...
            return _mapper.Map<PagedListMongo<PersistedGrantViewModel>>(paged);
        }
