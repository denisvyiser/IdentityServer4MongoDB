...
{
    public class ReadDeviceCodeStoreAppService : ReadGenericAppService<DeviceCodeViewModel, DeviceCodeStore, GetDeviceCodeStoreQuery, GetPagedDeviceCodeStoreQuery>, IReadDeviceCodeStoreAppService
    {
        private readonly IMapper _mapper;
        private readonly IMediatorHandler _mediator;
        private readonly DomainNotificationHandler _notifications;

        public ReadDeviceCodeStoreAppService(IMapper mapper, IMediatorHandler mediator) : base(mapper,mediator)
        {
            _mapper = mapper;
            _mediator = mediator;
        ...
        public async Task<PagedListMongo<ClientViewModel>> GetPagedFiltered(int page, int size, string orderProperty, bool orderCrescent, string sigla, string codigo)
        {
            ...
            var query = new GetPagedDeviceCodeStoreQuery()
            {
