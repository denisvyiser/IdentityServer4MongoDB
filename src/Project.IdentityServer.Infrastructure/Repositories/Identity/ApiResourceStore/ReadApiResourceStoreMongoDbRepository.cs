...
{
    public class ReadApiResourceStoreMongoDbRepository : ReadMongoDbRepository<ApiResourceStore>, IReadApiResourceStoreMongoDbRepository
    {
        public ReadApiResourceStoreMongoDbRepository(IReadMongoDbContext context) : base(context)
        {
        }
    }
}
