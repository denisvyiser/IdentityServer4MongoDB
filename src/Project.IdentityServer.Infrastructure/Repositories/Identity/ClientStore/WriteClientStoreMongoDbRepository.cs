...
{
    public class WriteClientStoreMongoDbRepository : WriteMongoDbRepository<ClientStore>, IWriteClientStoreMongoDbRepository
    {
        public WriteClientStoreMongoDbRepository(IWriteMongoDbContext context) : base(context)
        {
        }
