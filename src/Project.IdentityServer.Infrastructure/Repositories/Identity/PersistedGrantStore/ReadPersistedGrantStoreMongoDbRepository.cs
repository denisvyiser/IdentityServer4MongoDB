...
{
    public class ReadPersistedGrantStoreMongoDbRepository : ReadMongoDbRepository<PersistedGrantStore>, IReadPersistedGrantStoreMongoDbRepository
    {
        public ReadPersistedGrantStoreMongoDbRepository(IReadMongoDbContext context) : base(context)
        {
