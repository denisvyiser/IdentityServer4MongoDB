...
{
    public class ReadResourcesStoreMongoDbRepository : ReadMongoDbRepository<ResourcesStore>, IReadResourcesStoreMongoDbRepository
    {
        public ReadResourcesStoreMongoDbRepository(IReadMongoDbContext context) : base(context)
        {
